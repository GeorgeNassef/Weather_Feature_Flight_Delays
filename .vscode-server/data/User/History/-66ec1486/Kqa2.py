...
def recurData(min, allWe, timeIndex,offset):
    index = timeIndex[min]
    try:
    ...
    if offset > 0:
        ...
        offset = offset * -1 +1
    return(recurData(min+offset, allWe, timeIndex))
